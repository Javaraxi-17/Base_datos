...
public Cliente() {}
    public Cliente(int id,String nit,String nombres, String direccion, String apellidos, String telefono, String fn) {
        super(nombres, direccion, apellidos, telefono, fn);
        this.nit = nit;
        this.id = id;
    }
    ...
    try {
        ...
        cn.abrir_conexion();
        String query;
        query = "Select id_clientes as nit,nombres,apellidos,direccion,telefono,fecha_nacimiento from clientes";
    ...
    try {
        ...
        PreparedStatement parametro;
        String query = "delete db_empresa.clientes where id_clientes = ?";
        cn = new Conexion ();
        cn.abrir_conexion();
        parametro = (PreparedStatement) cn.conexionBD.prepareStatement(query);
